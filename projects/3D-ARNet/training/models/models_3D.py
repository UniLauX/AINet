...
class Inception_block_spectrum(nn.Module):
    def __init__(self, inplanes, planes):
        ...
        self.branch1 = nn.Sequential(
            Conv_bn(inplanes, inter_planes*2, kernel_size=1, stride=1),
            Conv_bn(inplanes*2, inter_planes*4, kernel_size=(3, 1, 1), stride=1, padding=(1, 0, 0))
        )
        self.branch2 = nn.Sequential(
            Conv_bn(inplanes, inter_planes, kernel_size=1, stride=1),
            Conv_bn(inplanes, inter_planes*2, kernel_size=(3, 1, 1), stride=1, padding=(1, 0, 0)),
...
class Inception_block_space(nn.Module):
    def __init__(self, inplanes, planes):
        ...
        self.branch1 = nn.Sequential(
            Conv_bn(inplanes, inter_planes*2, kernel_size=1, stride=1),
            Conv_bn(inplanes*2, inter_planes*4, kernel_size=(1, 3, 3), stride=1, padding=(0, 1, 1))
        )
        self.branch2 = nn.Sequential(
            Conv_bn(inplanes, inter_planes, kernel_size=1, stride=1),
            Conv_bn(inplanes, inter_planes*2, kernel_size=(1, 3, 3), stride=1, padding=(0, 1, 1)),
...
dict={'ARNet_1':ARNet_1, 'ARNet_2':ARNet_2}
